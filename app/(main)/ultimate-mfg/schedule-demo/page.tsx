...
export const metadata: Metadata = {
  title:
    "Ultimate Manufacturing ERP | Production Management System | Schedule Demo",
  description:
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/ultimate-mfg/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og//schedule-demo/ultimatemfg-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Ultimate Manufacturing ERP | Schedule Demo",
    description:
    ...
    images: [
      "https://optimumsystems.co.ke/og//schedule-demo/ultimatemfg-og-image.png",
    ],
  },
};
...
export default function Home() {
  const jsonLd = createJsonLdGraph([
    webPageSchema({
      title:
        "Ultimate Manufacturing ERP | Production Management System | Schedule Demo",
      path: "/ultimate-mfg/schedule-demo",
      description:
