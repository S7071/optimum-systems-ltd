...
import SecurityManagementSystemPage from "@/components/sms/page";
...
export const metadata: Metadata = {
  title: "Security Management System (SMS) for Safer Operations",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/sms-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://optimumsystems.co.ke/og/sms-og-image.png"],
  },
};
