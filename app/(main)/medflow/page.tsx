...
import MedFlowPage from "@/components/medflow/page";
...
export const metadata: Metadata = {
  title: "MedFlow Drug Tracking System for County Health Supply Chains",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/medflow-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "MedFlow Drug Tracking System",
    description:
    ...
    images: ["https://optimumsystems.co.ke/og/medflow-og-image.png"],
  },
};
