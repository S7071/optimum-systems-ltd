            ...
            <StatsSection
              ...
              title={
                <h3 className="text-2xl sm:text-4xl text-pretty leading-tight tracking-tight font-extrabold text-white">
                  Stay Ahead With{" "}
                  <span className="text-primary-cta">Real-Time</span> Supply Chain Intelligence
                </h3>
              }
              ...
              statCards={[
                {
                  value: "150+",
                  description: "Businesses successfully deployed across Kenya & East Africa",
                  icon: Users,
                  accent: false,
                },
                {
              ...
              caseStudies={[
                {
                  ...
                  title: "Savanna Distributors Scales to 5 Branches Without Adding Headcount",
                  stat: "35%",
                ...
                },
                {
                  ...
                  title: "Farmline Agrovet Eliminates Seasonal Stockouts With Smart Reordering",
                  stat: "50%",
                  statLabel: "Decrease in stockout incidents during peak planting season",
                  coverSrc:
                ...
                },
                {
                  ...
                  title: "Kariuki Retail Chain Achieves Full ETIMS Compliance in Under 30 Days",
                  stat: "60%",
