...
export const metadata: Metadata = {
  title:
    "Ultimate POS ERP | Retail & Wholesale Point of Sale System | Schedule Demo",
  description:
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/ultimate-pos/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og/schedule-demo/ultimatepos-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Ultimate POS ERP | Schedule Demo",
    description:
    ...
    images: [
      "https://optimumsystems.co.ke/og/schedule-demo/ultimatepos-og-image.png",
    ],
  },
};
...
export default function Home() {
  const jsonLd = createJsonLdGraph([
    webPageSchema({
      title:
        "Ultimate POS ERP | Retail & Wholesale Point of Sale System | Schedule Demo",
      path: "/ultimate-pos/schedule-demo",
      description:
