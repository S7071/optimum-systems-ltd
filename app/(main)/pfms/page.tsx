...
import PFMSPage from "@/components/pfms/page";
...
export const metadata: Metadata = {
  title: "Poultry Farm Management System (PFMS) for Smart Farming",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/pfms-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://optimumsystems.co.ke/og/pfms-og-image.png"],
  },
};
