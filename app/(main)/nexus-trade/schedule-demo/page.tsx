...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/nexus-trade/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og/schedule-demo/nexus-trade-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://optimumsystems.co.ke/og/schedule-demo/nexus-trade-og-image.png",
    ],
  },
};
...
export default function Home() {
  const jsonLd = createJsonLdGraph([
    webPageSchema({
      title: "NexusTrade AI Marketplace for Smarter Commerce",
      path: "/nexus-trade/schedule-demo",
      description:
