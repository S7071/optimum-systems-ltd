...
import QABPage from "@/components/qab/page";
...
export const metadata: Metadata = {
  title: "Qualification Award Board System (QAB) for TVETs in Kenya",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/qab-og-image.png",
        width: 1200,
        height: 630,
