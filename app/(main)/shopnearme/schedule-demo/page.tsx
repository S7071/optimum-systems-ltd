...
export const metadata: Metadata = {
  title: "ShopNearMe | Discover Local Products & Services | Schedule Demo",
  description:
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/shopnearme/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og/schedule-demo/shopnearme-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "ShopNearMe Marketplace | Schedule Demo",
    description:
      "Discover local products, services, and businesses near you with a smart marketplace platform.",
    images: [
      "https://optimumsystems.co.ke/og/schedule-demo/shopnearme-og-image.png",
    ],
  },
};
