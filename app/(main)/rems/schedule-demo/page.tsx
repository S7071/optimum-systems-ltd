...
export const metadata: Metadata = {
  title:
    "Real Estate Management System (REMS) for Property Operations | Schedule Demo",
  description:
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/rems/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og/schedule-demo/rems-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Real Estate Management System (REMS) | Schedule Demo",
    description:
      "Property management software for listings, tenants, leases, rent collection, maintenance, payments, and portfolio reports.",
    images: ["https://optimumsystems.co.ke/og/schedule-demo/rems-og-image.png"],
  },
};
