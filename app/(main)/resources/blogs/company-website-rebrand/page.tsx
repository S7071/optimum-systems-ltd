...
import CompanyRebrandBlogPost from "@/components/blog-posts/rebrand-post";

export const metadata: Metadata = {
  title: "Company Website Rebrand Blog Post - Optimum ERP Systems Ltd",
  description:
