...
import TurnstileBiometricGateControlSystemPage from "@/components/turnstile-biometric-gate-control/page";
...
export const metadata: Metadata = {
  title: "Turnstile Biometric Gate Control System for Secure Access",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/turnstile-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Turnstile Biometric Gate Control System",
    description:
    ...
    images: ["https://optimumsystems.co.ke/og/turnstile-og-image.png"],
  },
};
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full items-start justify-start bg-zinc-50 font-sans dark:bg-black">
      ...
      <SiteBanner />
      <SiteNavbar />
      <TurnstileBiometricGateControlSystemPage />
      <SiteFooter />
    </div>
  );
}
