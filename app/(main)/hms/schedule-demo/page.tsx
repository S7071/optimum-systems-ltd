...
export const metadata: Metadata = {
  title:
    "Hospital Management System (HMS) for Healthcare Facilities | Schedule Demo",
  description:
  ...
  openGraph: {
    ...
    url: "https://optimumsystems.co.ke/hms/schedule-demo",
    siteName: "Optimum ERP Systems Ltd",
    images: [
      {
        url: "https://optimumsystems.co.ke/og/schedule-demo/hms-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Hospital Management System (HMS) | Schedule Demo",
    description:
      "Manage patient care, billing, pharmacy, lab services, and hospital workflows with HMS.",
    images: ["https://optimumsystems.co.ke/og/schedule-demo/hms-og-image.png"],
  },
};
...
export default function Home() {
  const jsonLd = createJsonLdGraph([
    webPageSchema({
      title: "Hospital Management System (HMS) for Healthcare Facilities | Schedule Demo",
      path: "/hms/schedule-demo",
      description:
