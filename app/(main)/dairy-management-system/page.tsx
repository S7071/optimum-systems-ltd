...
import DairyManagementSystemPage from "@/components/dairy-management-system/page";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://optimumsystems.co.ke/og/dairy-og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://optimumsystems.co.ke/og/dairy-og-image.png",
    ],
  },
};
