        ...
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[calc(100vh-64px)] max-h-[760px]">
          ...
          >
            ...
            <p className="text-primary-cbe-800 text-base leading-relaxed max-w-[340px] sm:max-w-[440px]">
              ...
              ERP platform that connects production planning, inventory,
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            <SectionHeading
              ...
              title="What is Ultimate Manufacturing ERP?"
              description="A comprehensive and fully integrated ERP solution that connects production planning, inventory, procurement, sales, and financial management within a single centralized system."
            />
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Use production planning tools, Bill of Materials, and work
                order management to forecast requirements, optimize scheduling,
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    ...
                    across departments throughout the entire manufacturing cycle.
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-4">
                <h2 className="text-xl font-extrabold leading-tight tracking-tight text-white sm:text-3xl lg:text-4xl">
                  ...
                  <br />
                  with <span className="text-primary-cta">Ultimate</span>{" "}
                  Manufacturing ERP
                </h2>
