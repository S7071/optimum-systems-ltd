...
const operationsItems: CardItem[] = [
  {
    title: "Production Planning",
    description:
      "Coordinate production schedules, work orders, and resource requirements from one connected workflow.",
    icon: Layers3,
  },
  {
    title: "Inventory Control",
    description:
      "Track raw materials, stock movement, warehouse activity, and availability needed to keep production moving.",
    icon: Building2,
  },
  {
    title: "Procurement Visibility",
    description:
      "Manage sourcing, supplier activity, purchase orders, and goods receipt with tighter operational coordination.",
    icon: Database,
  },
  {
    title: "Cost & Profitability Tracking",
    description:
      "Monitor material, labor, and operational costs in real time to improve manufacturing performance and margins.",
    icon: BarChart3,
  },
  {
    title: "Financial Oversight",
    description:
      "Centralize reporting and financial visibility to support better planning, control, and decision-making.",
    icon: Lock,
  },
];
...
const featureItems: CardItem[] = [
  {
    ...
    description:
      "Automate work order generation, plan production schedules, and align material and machine requirements to meet delivery timelines efficiently.",
    icon: Layers3,
  },
  {
    title: "Bill of Materials (BOM) Management",
    description:
      "Manage and track raw materials, components, and production requirements with real-time visibility and accurate cost calculations.",
    icon: ClipboardCheck,
  },
  {
    title: "Work in Progress (WIP) Tracking",
    description:
      "Monitor production at every stage, track progress, and gain real-time insights into manufacturing performance and workflow efficiency.",
    icon: BarChart3,
  },
  {
    title: "Costing & Profitability Analysis",
    description:
      "Track material, labor, and operational costs, analyze variances, and gain full visibility into production profitability.",
    icon: FileBarChart2,
  },
  {
    title: "Inventory & Warehouse Management",
    description:
      "Control stock levels, manage warehouses, track material movement, and optimize inventory to support uninterrupted production.",
    icon: Building2,
  },
  {
    title: "Procurement Management",
    description:
      "Streamline sourcing, supplier management, purchase orders, and goods receipt processes with full tracking and integration to inventory and finance.",
    icon: Database,
  },
  {
    title: "Sales & Order Management",
    description:
      "Manage quotations, sales orders, and customer accounts while aligning production with demand and improving order fulfillment accuracy.",
    icon: CheckCircle2,
  },
  {
    title: "Financial Management & Reporting",
    description:
      "Centralize accounting, track financial performance, and generate comprehensive reports to support informed decision-making.",
    icon: Lock,
  },
  {
    title: "HR & Payroll Management",
    description:
      "Manage workforce data, payroll processing, attendance, and staff performance to support efficient operations.",
    icon: Users,
  },
];
...
export default function UltimateManufacturingPage() {
    ...
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-284px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              Take full control of your manufacturing operations with a unified
              ERP platform that connects{" "}
              ...
              , procurement, sales, and financial management in one centralized
              system.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/ultimate-manufacturing/schedule-demo");
                }}
              >
                Book a Demo
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogTitle className="sr-only">
                  Ultimate Manufacturing ERP Overview
                </DialogTitle>
                <DialogContent className="max-w-4xl overflow-hidden p-0">
                  <div className="aspect-video w-full">
                    <iframe
                      ...
                      title="Ultimate Manufacturing ERP Overview"
            ...
            >
              ...
              <span className="text-sm text-slate-600">
                ...
                · centralizes{" "}
                <strong className="font-semibold text-primary-cbe-500">
                  planning, production, inventory, and profitability
                </strong>
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <Image
                ...
                alt="Manufacturing production operations and shop floor control"
                fill
                priority
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold leading-tight text-slate-800">
                  Unified manufacturing control
                </p>
                <p className="mt-0.5 text-sm text-slate-400">
                  Planning, inventory, procurement, sales, and finance in one
                  platform
                </p>
              </div>
            </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is{" "}
                <span className="text-primary-cta">Ultimate</span> Manufacturing
                ERP?
              </motion.h2>
              <motion.p
                variants={fadeUp}
              ...
              >
                A comprehensive and fully integrated ERP solution that connects
                production planning, inventory, procurement, sales, and
                financial management within a single centralized system.
              </motion.p>
            </div>
            ...
            >
              <motion.p variants={fadeUp}>
                Built for manufacturing environments where precision,
                coordination, and timely decision-making are essential, yet many
                organizations still operate with fragmented processes and
                limited visibility across production cycles.
              </motion.p>
              <motion.p variants={fadeUp}>
                The platform helps businesses accurately plan production,
                control inventory, track work in progress, monitor costs, and
                maintain profitability while improving delivery timelines and
          ...
          >
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                A Fully Integrated Manufacturing Platform
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Connect production planning, inventory, procurement, sales, and
                financial management within one centralized system.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Plan Production with Precision
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Use production planning tools, Bill of Materials, and work order
                management to forecast requirements, optimize scheduling, and
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for control from planning to profitability
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Monitor work in progress, analyze material, labor, and
                    operational costs in real time, and improve coordination
                    across departments throughout the entire manufacturing
                    cycle.
                  </p>
                </div>
      ...
      >
        ...
        >
          ...
          >
            Ultimate Manufacturing ERP centralizes planning, production
            execution, inventory, costing, procurement, sales, and finance so
            manufacturers can reduce delays, control costs, and maximize
            output.
          </motion.p>
        </motion.div>
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Ultimate Manufacturing ERP" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Production Control, Visibility, and{" "}
            <span className="text-primary-cta">Profitability.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "A Fully Integrated Manufacturing Platform",
              description:
                "Connect production planning, inventory, procurement, sales, and financial management within one centralized ERP system.",
              icon: GraduationCap,
              cta: "View Platform",
              featured: false,
            },
            {
              title: "Plan Production with Precision",
              description:
                "Leverage production planning tools, Bill of Materials, and work order management to forecast requirements and optimize scheduling.",
              icon: CheckCircle2,
              cta: "See Planning",
              featured: true,
            },
            {
              title: "Track Every Stage of Production in Real Time",
              description:
                "Monitor work in progress, production performance, and resource utilization at every stage for full operational visibility.",
              icon: Workflow,
              cta: "Track Production",
              featured: false,
            },
            {
              title: "Control Costs & Improve Profitability",
              description:
                "Track material, labor, and operational costs in real time, analyze variances, and gain insight into production efficiency.",
              icon: Layers3,
              cta: "Review Costs",
              featured: false,
            },
            {
              title: "Drive Efficiency Across the Entire Operation",
              description:
                "Integrate procurement, inventory, sales, and finance to eliminate silos, reduce manual work, and improve coordination.",
              icon: FileBarChart2,
              cta: "Explore Efficiency",
              featured: false,
            },
            {
              title: "Everything You Need to Plan, Produce, and Profit",
              description:
                "Bring production planning, BOM, WIP, inventory, procurement, sales, finance, and HR into one coordinated system.",
              icon: BarChart3,
              cta: "View Modules",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Plan, <br />
            Produce, and <span className="text-primary-cta">Profit.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From production planning and BOM management to WIP tracking,
            costing, inventory, procurement, sales, finance, and HR, the
            platform connects the full manufacturing cycle.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Plan, Produce, and{" "}
            <span className="text-primary-cta">Profit.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  <motion.p
                    ...
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    Ultimate Manufacturing ERP brings the core operational areas
                    manufacturers need into one coordinated environment for
                    better planning, visibility, and execution.
                  </motion.p>
                </div>
              </div>
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "Production planning and work order control",
                    "Inventory and warehouse visibility",
                    "Procurement and supplier coordination",
                    "Real-time costing and profitability analysis",
                    "Sales and finance integration across the operation",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  Streamline production, gain full operational control, and
                  drive efficiency across your entire manufacturing process.
                  Reduce costs, improve output, and make smarter decisions with
                  a fully integrated system designed for modern manufacturing
                  environments.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  ...
                  <DialogTitle className="sr-only">
                    Ultimate Manufacturing ERP Product Overview
                  </DialogTitle>
                  <DialogContent className="max-w-4xl overflow-hidden p-0">
                    <div className="aspect-video w-full">
                      <iframe
                        className="h-full w-full"
                        src="https://www.youtube.com/embed/Da1hUqzoiAo?autoplay=1"
                        title="Ultimate Manufacturing ERP Product Overview"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    </div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        Ultimate Manufacturing ERP Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Production control, inventory, costing, and performance
                        in one view
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Monitor production at every stage, track progress, and
                        gain real-time insight into manufacturing performance.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Track material, labor, and operational costs in real
                        time and gain visibility into production profitability.
                      </p>
                    </div>
                  </div>
                </motion.div>
