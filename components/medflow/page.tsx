...
const complianceItems: CardItem[] = [
  {
    ...
    description:
      "Controls who can view, approve, transfer, and manage stock across the county supply chain.",
    icon: BadgeCheck,
  },
  {
    title: "Biometric-Secured Transfers",
    description:
      "Supports secure handovers with biometric-backed movement confirmation for higher accountability.",
    icon: Landmark,
  },
  {
    title: "Geo-Fenced Visibility",
    description:
      "Strengthens movement control with location-aware visibility across stores, facilities, and delivery points.",
    icon: ClipboardCheck,
  },
  {
    title: "GRN Management",
    description:
      "Supports goods received note workflows for controlled receiving and accurate stock reconciliation.",
    icon: Network,
  },
  {
    title: "Audit & Dashboard Oversight",
    description:
      "Provides traceable records and role-based dashboards for stronger transparency and decision-making.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "End-to-End Drug Tracking",
    description:
      "Tracks medicines from KEMSA to county stores, facilities, and the patient point of issue.",
    icon: Layers3,
  },
  {
    title: "Automated Requisitions",
    description:
      "Streamlines facility requests and replenishment workflows to reduce delays and manual follow-up.",
    icon: ClipboardCheck,
  },
  {
    title: "Real-Time Stock Visibility",
    description:
      "Shows live stock positions across county warehouses and facilities for faster operational decisions.",
    icon: BarChart3,
  },
  {
    title: "GRNs & Receiving Control",
    description:
      "Captures goods received notes and receipt workflows for cleaner stock reconciliation and accountability.",
    icon: FileBarChart2,
  },
  {
    title: "Role-Based Dashboards",
    description:
      "Gives counties, stores, and facilities tailored dashboards for oversight, operations, and reporting.",
    icon: Building2,
  },
  {
    title: "Secure Transfers & Controls",
    description:
      "Supports biometric-secured transfers, controlled approvals, and stronger stock movement integrity.",
    icon: Lock,
  },
  {
    title: "County Supply Chain Coordination",
    description:
      "Connects KEMSA receipts, county stores, facility issues, and patient-level tracking in one workflow.",
    icon: Database,
  },
  {
    title: "Expiry, Theft & Stockout Reduction",
    description:
      "Improves visibility and controls that help minimize losses, expiries, and critical stock shortages.",
    icon: Users,
  },
];
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-64px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              Manage pharmaceutical supply chains with MedFlow — a cloud-based
              platform built for county health systems with{" "}
              ...
              , and secure movement control from KEMSA to the patient.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/medflow/schedule-demo");
                }}
              >
                Book a Demo
                ...
                <DialogContent className="max-w-4xl overflow-hidden p-0">
                  <div className="aspect-video w-full">
                    <iframe
                      ...
                      title="MedFlow Product Overview"
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-400">
                  Live movement and stock monitoring
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">MedFlow</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mt-4 text-base leading-7 text-slate-600 sm:text-lg"
              >
                A cloud-based drug tracking and management platform built for
                county health systems to control pharmaceutical movement from
                supply to patient issue.
              </motion.p>
            </div>
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for county governments and public
                health teams that need tighter stock control, cleaner
                requisition workflows, and real-time visibility across the
                supply chain.
              </motion.p>
              <motion.p variants={fadeUp}>
                It centralizes drug movement, receiving, transfers, and
                consumption into one connected system so decision-makers can
                reduce losses and improve service delivery.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Tracks medicine movement from KEMSA through county stores and
                facilities to the final point of issue.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Improves visibility with role-based dashboards, secure
                transfers, and controlled stock workflows.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for public health accountability
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    County health systems need more than manual stock books.
                    MedFlow supports a broader shift toward transparent,
                    controlled, and efficient pharmaceutical supply operations.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why MedFlow" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
          ...
          >
            ...
            Visibility, and{" "}
            <span className="text-primary-cta">Accountability.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            MedFlow combines traceability, stock control, secure movement
            workflows, and real-time dashboard visibility in one connected
            platform.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why MedFlow" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Control, Visibility, and{" "}
            <span className="text-primary-cta">Accountability.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Built for County Health Systems",
              description:
                "Designed for county governments, public health departments, and facilities managing medicine supply chains at scale.",
              icon: GraduationCap,
              cta: "Track Supply",
              featured: false,
            },
            {
              title: "End-to-End Drug Flow",
              description:
                "Tracks stock movement from KEMSA to county stores, facilities, and patient issue points within one workflow.",
              icon: CheckCircle2,
              cta: "View Dashboards",
              featured: true,
            },
            {
              title: "Controlled Requisition Workflows",
              description:
                "Automates requisitions and approvals so facilities request and receive stock more efficiently.",
              icon: Workflow,
              cta: "Manage Requests",
              featured: false,
            },
            {
              title: "Secure Transfers & Handover",
              description:
                "Supports biometric-secured transfers and tighter movement controls to strengthen accountability.",
              icon: Layers3,
              cta: "Monitor Transfers",
              featured: false,
            },
            {
              title: "Reduced Losses & Expiries",
              description:
                "Improves oversight to help minimize theft, stock expiries, and avoidable stockouts across facilities.",
              icon: FileBarChart2,
              cta: "Control Receiving",
              featured: false,
            },
            {
              title: "Real-Time Oversight",
              description:
                "Gives decision-makers live visibility into stock positions, movements, and operational performance.",
              icon: BarChart3,
              cta: "See Visibility",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Pharmaceutical{" "}
            <span className="text-primary-cta">Supply Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From requisitions and GRNs to transfers, dashboards, and end-point
            tracking, MedFlow centralizes the pharmaceutical supply chain stack.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Pharmaceutical{" "}
            <span className="text-primary-cta">Supply Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
              ...
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  <motion.h2
                    ...
                    className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
                  >
                    Designed to Operate With Strong{" "}
                  ...
                  <motion.p
                    ...
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    MedFlow supports controlled operations through secure
                    transfers, audit-ready workflows, and role-based
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    ...
                    "Biometric-secured transfer workflows",
                    "Geo-fenced stock movement visibility",
                    "GRN-backed receiving controls",
                    "Audit-ready dashboards and logs",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
            ...
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  ...
                  <br />
                  Supply Oversight with
                  <span className="text-primary-cta"> MedFlow</span>
                </motion.h2>
                ...
                >
                  Digitize county pharmaceutical operations with a platform
                  built for end-to-end traceability, automated requisitions,
                  secure stock movement, and real-time dashboard oversight.
                </motion.p>
              </motion.div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        MedFlow Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Drug tracking and supply visibility for county health
                        systems
                      </p>
                    </div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Pharmaceutical Supply Control with{" "}
                  <span className="text-primary-cta">MedFlow</span>.
                </motion.h2>
                ...
                >
                  Reduce theft, expiries, and stockouts with cloud-based drug
                  tracking built for county health operations.
                </motion.p>
              </div>
