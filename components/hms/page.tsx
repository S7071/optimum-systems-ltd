...
const complianceItems: CardItem[] = [
  {
    ...
    description:
      "Supports secure handling of patient information with controlled access and strong data governance practices.",
    icon: ShieldCheck,
  },
  {
    title: "Role-Based Access Control",
    description:
      "Ensures staff access is enabled to responsibilities for safer workflows and tighter operational control.",
    icon: Lock,
  },
  {
    title: "Secure EHR Governance",
    description:
      "Centralizes electronic health records in a protected environment built for accuracy, traceability, and continuity of care.",
    icon: Database,
  },
  {
    title: "Insurance Workflow Readiness",
    description:
      "Supports insurance-linked billing processes to strengthen reimbursement accuracy and financial accountability.",
    icon: ClipboardCheck,
  },
  {
    title: "Audit & Accountability",
    description:
      "Improves transparency across appointments, billing, stock movements, and patient service workflows.",
    icon: BadgeCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    ...
    description:
      "Digitizes patient onboarding and centralizes records for faster access and better continuity of care.",
    icon: Users,
  },
  {
    title: "Appointment & Scheduling",
    description:
      "Manages appointments efficiently to reduce wait times and improve coordination across departments.",
    icon: ClipboardCheck,
  },
  {
    title: "Electronic Health Records",
    description:
      "Maintains accurate, accessible patient histories and clinical information in one delivered system.",
    icon: FileBarChart2,
  },
  {
    title: "Billing & Insurance Integration",
    description:
      "Supports billing workflows and insurance-linked processing for stronger revenue control.",
    icon: Landmark,
  },
  {
    title: "Inventory & Stock Control",
    description:
      "Tracks medical supplies and inventory to reduce stock issues and support uninterrupted care delivery.",
    icon: Layers3,
  },
  {
    title: "Staff & Department Management",
    description:
      "Helps coordinate staff operations and administrative workflows across the healthcare facility.",
    icon: Building2,
  },
  {
    title: "SMS Reminders & Notifications",
    description:
      "Improves patient communication through automated reminders and operational notifications.",
    icon: Phone,
  },
  {
    title: "Security, Compliance & Visibility",
    description:
      "Combines secure access, auditability, and real-time reporting for dependable healthcare operations.",
    icon: ShieldCheck,
  },
];
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
        ...
        <div className="grid min-h-[calc(100vh-284px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              ...
              <span className="text-xs font-extrabold uppercase tracking-widest text-primary-cbe-500">
                <span className="text-primary-cta">Ultimate</span> HOSPITAL
                MANAGEMENT SYSTEM
              </span>
            </motion.div>
            ...
            >
              Digitize patient care with HMS — a comprehensive cloud-based
              platform for appointments, staff coordination, billing, inventory,
              and{" "}
              <strong className="font-semibold text-primary-cbe-500">
                electronic health records
              </strong>
              , built to improve efficiency, strengthen{" "}
              <strong className="font-semibold text-primary-cbe-500">
                care coordination
              </strong>
              , and reduce operational delays.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/hospital-management-system/schedule-demo");
                }}
              >
                Book a Demo
            ...
            >
              ...
              <span className="text-sm text-slate-600">
                ...
                · ideal for hospitals, clinics, and health centres
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <Image
                src="/heros/hms.jpg"
                alt="Healthcare professionals using a digital hospital management system"
                fill
                priority
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold leading-tight text-slate-800">
                  Appointments, Billing & EHR
                </p>
                <p className="mt-0.5 text-sm text-slate-400">
                  One delivered healthcare platform
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                ...
                <span className="text-primary-cta">(HMS)</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mt-4 text-base leading-7 text-slate-600 sm:text-lg"
              >
                A comprehensive cloud-based platform for managing patient care,
                appointments, staff, billing, inventory, and electronic health
                records from one delivered environment.
              </motion.p>
            </div>
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for hospitals, clinics, and health
                centres seeking faster service delivery, better coordination
                across teams, and stronger administrative control.
              </motion.p>
              <motion.p variants={fadeUp}>
                It replaces fragmented tools and manual processes with
                streamlined workflows that reduce errors, shorten wait times,
                and improve care continuity and revenue oversight.
              </motion.p>
            </motion.div>
            ...
            >
              {["Hospitals", "Clinics", "Health Centres"].map((pathway) => (
                <motion.span
                  key={pathway}
                  variants={fadeUp}
                  whileHover={{ y: -3 }}
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Delivers accessible, delivered hospital operations through a
                secure cloud-based platform built for modern care environments.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Connects appointments, records, billing, and inventory around
                the patient journey for more coordinated service delivery.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for end-to-end healthcare operations
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Healthcare providers need more than standalone systems. HMS
                    supports a broader shift toward efficient, secure, and
                    accountable service delivery across clinical and
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why HMS" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Faster Care, <br />
            Safer Records, and{" "}
            <span className="text-primary-cta">Better Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            HMS combines patient care coordination, appointments, billing,
            inventory control, and secure records management in one connected
            platform.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why HMS" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Faster Care, Safer Records, and{" "}
            <span className="text-primary-cta">Better Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Centralized Patient Care",
              description:
                "Unifies patient records, appointments, and service workflows to support smoother care delivery across the facility.",
              icon: GraduationCap,
              cta: "Manage Patients",
              featured: false,
            },
            {
              ...
              description:
                "Gives teams connected access to hospital operations from a centralized cloud environment built for speed and continuity.",
              icon: CheckCircle2,
              cta: "Connected Access",
              featured: true,
            },
            {
              title: "Appointment & Queue Coordination",
              description:
                "Improves scheduling and patient flow to cut wait times and support better staff coordination.",
              icon: Workflow,
              cta: "View Schedules",
              featured: false,
            },
            {
              title: "Billing & Revenue Control",
              description:
                "Supports billing accuracy, insurance-linked processing, and tighter financial oversight across healthcare services.",
              icon: Layers3,
              cta: "Manage Billing",
              featured: false,
            },
            {
              ...
              description:
                "Tracks supplies and stock movements more effectively to reduce disruptions and strengthen service readiness.",
              icon: FileBarChart2,
              cta: "Track Inventory",
              featured: false,
            },
            {
              ...
              description:
                "Protects sensitive patient information with controlled access, secure records, and accountable operational workflows.",
              icon: BarChart3,
              cta: "Secure Access",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Digital{" "}
            <span className="text-primary-cta">Healthcare Operations.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From patient registration and appointments to billing, inventory,
            SMS reminders, and EHR, HMS centralizes the operational core of
            healthcare delivery.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Digital{" "}
            <span className="text-primary-cta">Healthcare Operations.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
              ...
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  <motion.h2
                    ...
                    className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
                  >
                    Built for Secure, Controlled, and{" "}
                    <span className="text-primary-cta">
                      Accountable Healthcare Operations.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    HMS supports secure patient information handling, controlled
                    access, and accountable workflows across digitized
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    ...
                    "Data protection and secure patient information handling",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
            ...
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  ...
                  <br />
                  with <span className="text-primary-cta">HMS</span>
                </motion.h2>
                ...
                >
                  Deliver faster, more coordinated, and more accountable
                  healthcare operations. HMS helps facilities manage patient
                  care, appointments, billing, inventory, and secure electronic
                  records from one connected cloud platform.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  ...
                  <DialogTitle className="sr-only">
                    Hospital Management System Product Overview
                  </DialogTitle>
                  <DialogContent className="max-w-4xl overflow-hidden p-0">
                    <div className="aspect-video w-full">
                      <iframe
                        className="h-full w-full"
                        src="https://www.youtube.com/embed/Da1hUqzoiAo?autoplay=1"
                        title="Hospital Management System Product Overview"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    </div>
              ...
              >
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-white/55">
                        Connected hospital operations in one cloud platform
                      </p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-[1.4rem] bg-white">
                    ...
                    >
                      <Image
                        ...
                        alt="Hospital Management System product preview"
                        width={1400}
                        height={900}
                        priority
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-primary-cbe-500 line-clamp-2">
                        Electronic Health Records
                      </p>
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Centralize patient histories, treatment details, and
                        records for faster clinical access.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Strengthen billing accuracy and support insurance-linked
                        financial workflows.
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Hospital Operations with{" "}
                  <span className="text-primary-cta">HMS</span>.
                </motion.h2>
                ...
                >
                  Improve care coordination, reduce delays, and strengthen
                  billing and inventory control with one connected hospital
                  platform.
                </motion.p>
              </div>
