        ...
        <div className="grid grid-cols-1 items-center md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-6 lg:col-span-7">
            ...
            <p className="mb-0 max-w-xl text-slate-400">
              Stay connected to your school&apos;s assessment activities from
              anywhere. The UltimateCBE mobile app gives teachers, parents, and
              administrators instant access to student performance data,
              competency reports, attendance records, and real-time
              notifications — all from the palm of their hand. Designed for
              Kenyan schools embracing the CBC curriculum.
            </p>
