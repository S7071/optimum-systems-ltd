...
const complianceItems: CardItem[] = [
  {
    title: "CBET-CDACC Alignment",
    description:
      "Supports modularized CBET governance aligned to competency standards, occupational requirements, and approved curriculum structures.",
    icon: BadgeCheck,
  },
  {
    title: "TVETA Readiness",
    description:
      "Strengthens institutional quality assurance by supporting structured progression records, completion tracking, and accreditation readiness.",
    icon: Landmark,
  },
  {
    title: "Occupational Standards",
    description:
      "Defines modules with competencies, learning outcomes, performance criteria, and credits in line with regulated training expectations.",
    icon: ClipboardCheck,
  },
  {
    title: "ERP-Connected Governance",
    description:
      "Integrates securely with institutional ERP workflows for registration, scheduling, exams, and certification processes.",
    icon: Network,
  },
  {
    title: "Data Protection & Auditability",
    description:
      "Provides role-based access, audit trails, and secure records handling to support accountable academic governance.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "Module Definition & Sequencing",
    description:
      "Define and sequence modules with competencies, learning outcomes, performance criteria, and credits in one structured workflow.",
    icon: Layers3,
  },
  {
    title: "Competency & Outcome Mapping",
    description:
      "Map assessments directly to competencies and learning outcomes for consistent, unambiguous grading and stronger governance.",
    icon: BadgeCheck,
  },
  {
    title: "Formative & Summative Assessments",
    description:
      "Track formative and summative assessments across modules with clear linkage to learner progression and curriculum requirements.",
    icon: ClipboardCheck,
  },
  {
    title: "Practical Verification & Remedials",
    description:
      "Capture practical verifications, remedial actions, and follow-up outcomes within a controlled academic workflow.",
    icon: Workflow,
  },
  {
    title: "Learner Progression Tracking",
    description:
      "Monitor individual learner progress, competency attainment, completion status, and progression trends in real time.",
    icon: BarChart3,
  },
  {
    title: "Compliance & Accreditation Reports",
    description:
      "Generate automated reports on enrollments, completion rates, competency statistics, and progression analytics for quality assurance.",
    icon: FileBarChart2,
  },
  {
    title: "Role-Based Access & Audit Trails",
    description:
      "Secure every action with controlled access, traceable activity logs, and accountable governance across departments.",
    icon: Lock,
  },
  {
    title: "ERP Integration & Certification Workflows",
    description:
      "Connect seamlessly with registration, scheduling, exams, and certification systems to eliminate fragmented processes.",
    icon: Database,
  },
];
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-64px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              Modularized CBET Governance for{" "}
            ...
            >
              Automate modularized curriculum control with CBET — a secure
              governance platform for TVET and technical institutions with
              real-time learner progression,{" "}
            ...
            >
              ...
              <span className="text-[13px] text-slate-600">
                ...
                · ideal for{" "}
                <strong className="font-medium text-primary-cbe-500">
                  technical colleges and multi-campus institutions
                </strong>
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            <Image
              ...
              alt="CBET curriculum governance and learner progression"
              fill
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-400">
                  Progression and competency analytics
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">CBET</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mt-4 text-base leading-7 text-slate-600 sm:text-lg"
              >
                A comprehensive digital platform that automates and structures
                the management of modularized CBET curricula for TVET and
            ...
            >
              <motion.p variants={fadeUp}>
                ...
                modularized CBET curricula and seeking stronger control over
                competencies, credits, learner progression, and assessment
                governance.
              </motion.p>
              <motion.p variants={fadeUp}>
                It centralizes module sequencing, competency-based assessment
                mapping, completion tracking, audit trails, and
                accreditation-ready reporting inside one connected system.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Module Sequencing & Credits
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Define modules with competencies, learning outcomes, performance
                criteria, and credits in line with structured CBET delivery.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Map every assessment directly to competencies for consistent
                grading, reduced irregularities, and stronger academic
                accountability.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Institutions need more than digital marksheets. CBET
                    supports structured curriculum control, learner progression
                    oversight, compliance reporting, and secure ERP-connected
                    workflows across academic operations.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why CBET" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Built for Governance, <br />
            Progression, and{" "}
            <span className="text-primary-cta">Compliance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            CBET combines curriculum structure, competency tracking, compliance
            reporting, and audit-ready control in one product experience.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why CBET" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Built for Governance, Progression, and{" "}
            <span className="text-primary-cta">Compliance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Designed for Modularized CBET",
              description:
                "Built specifically for TVET and technical institutions managing modules, competencies, credits, and learner outcomes.",
              icon: GraduationCap,
              cta: "Manage Modules",
              featured: false,
            },
            {
              title: "Aligned to Standards & Accreditation",
              description:
                "Supports occupational standards, quality assurance workflows, and institutional compliance requirements for regulated delivery.",
              icon: CheckCircle2,
              cta: "View Compliance",
              featured: true,
            },
            {
              title: "Structured Assessment Governance",
              description:
                "Manages formative, summative, practical verification, and remedial workflows inside one connected platform.",
              icon: Workflow,
              cta: "Track Assessments",
              featured: false,
            },
            {
              title: "Competency-Based Grading Consistency",
              description:
                "Maps assessments directly to competencies and performance criteria for clearer, more consistent evaluation.",
              icon: Layers3,
              cta: "Map Competencies",
              featured: false,
            },
            {
              title: "Reduced Manual Irregularities",
              description:
                "Minimizes administrative burden, compliance risk, and manual inconsistencies across curriculum and assessment operations.",
              icon: FileBarChart2,
              cta: "Generate Reports",
              featured: false,
            },
            {
              title: "Real-Time Learner Visibility",
              description:
                "Provides instant insight into progression, completion status, and competency attainment across the institution.",
              icon: BarChart3,
      ...
      >
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Structured <br />
            Modularized{" "}
            <span className="text-primary-cta">CBET Governance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From defining competencies and credits to tracking assessments,
            remedials, completion status, and accreditation reporting, CBET
            centralizes the governance stack.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Structured Modularized{" "}
            <span className="text-primary-cta">CBET Governance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            ...
            <motion.div variants={fadeLeft}>
                ...
                <div className="flex flex-col items-start gap-3">
                  ...
                  >
                    ...
                    <span className="text-primary-cta">
                      Curriculum and Institutional Standards.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    CBET supports approved curriculum control, accreditation
                    readiness, and secure institutional operations with
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "CBET-CDACC and modularized curriculum governance",
                    "TVETA quality assurance and accreditation readiness",
                    "Occupational standards, competencies, and credit structures",
                    "ERP integration for registration, exams, and certification",
                    "Kenya Data Protection and audit-ready access control",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  Transform Modularized Curriculum
                  <br />
                  Governance with
                  <span className="text-primary-cta"> CBET</span>
                </motion.h2>
                ...
                >
                  Deliver structured, compliant, and efficient modularized CBET
                  management for TVET and technical institutions. CBET helps
                  institutions define modules, track learner progression, manage
                  assessments, and generate accreditation-ready reports from one
                  connected platform.
                </motion.p>
              </motion.div>
              ...
              >
                {[
                  ...
                  "Compliance & Accreditation Reports",
                ].map((item) => (
                  <motion.div
                    key={item}
                    variants={fadeUp}
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        CBET Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Structured curriculum governance for TVET institutions
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Align modules, outcomes, performance criteria, and
                        assessments in one controlled workflow.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Monitor formative, summative, remedial, and completion
                        status with clarity.
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Modularized CBET Governance with{" "}
                  <span className="text-primary-cta">CBET</span>.
                </motion.h2>
                ...
                >
                  Deliver structured, compliant, and efficient management of
                  modularized curricula, assessments, learner progression, and
