  ...
  return (
    <>
      ...
      <section className="w-full bg-[#F8F9FA]">
        ...
        {/* ── HERO ── */}
        <div
          className="relative overflow-hidden px-6 pb-20 pt-[72px] text-center bg-gradient-to-tr from-primary-cbe-800 via-primary-cbe-500 to-primary-cbe-800"
        >
          ...
          {/* Badge */}
          <BadgePill label="Get in Touch" centered={true} />
        ...
        <div className="relative z-10 mx-auto -mt-8 grid max-w-5xl grid-cols-1 gap-6 px-6 pb-20 lg:grid-cols-[320px_1fr]">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Office Hours box */}
            <div
              className="avail-animate rounded-[14px] px-5 py-[22px] bg-gradient-to-tr from-primary-cbe-800 via-primary-cbe-500 to-primary-cbe-800"
            >
