...
const complianceItems: CardItem[] = [
  {
    ...
    description:
      "Uses fingerprint-based verification to strengthen attendance integrity for staff and students.",
    icon: BadgeCheck,
  },
  {
    title: "Secure Access Controls",
    description:
      "Supports controlled attendance workflows with stronger protection around sensitive attendance records.",
    icon: Landmark,
  },
  {
    title: "Audit-Ready Records",
    description:
      "Helps maintain clear attendance histories that reduce disputes and support accountability.",
    icon: ClipboardCheck,
  },
  {
    title: "Integration Ready",
    description:
      "Designed to support integration with broader institutional systems and operational workflows.",
    icon: Network,
  },
  {
    title: "Data Protection",
    description:
      "Supports secure data handling in line with Optimum’s broader security and governance approach.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "Fingerprint Attendance Capture",
    description:
      "Captures staff and student attendance through fingerprint verification for more reliable records.",
    icon: Layers3,
  },
  {
    title: "Trainer-Initiated Sessions",
    description:
      "Supports trainer-led attendance sessions to improve control over when and how attendance is recorded.",
    icon: ClipboardCheck,
  },
  {
    title: "Real-Time Attendance Reporting",
    description:
      "Provides immediate visibility into attendance activity, session status, and participation trends.",
    icon: BarChart3,
  },
  {
    title: "Automatic Percentage Calculation",
    description:
      "Automatically calculates attendance percentages to reduce manual work and reporting delays.",
    icon: FileBarChart2,
  },
  {
    title: "Staff & Student Management",
    description:
      "Supports attendance tracking across both staff and student groups from one connected platform.",
    icon: Building2,
  },
  {
    title: "Secure Biometric Records",
    description:
      "Helps protect sensitive attendance information with secure, controlled biometric record handling.",
    icon: Lock,
  },
  {
    title: "System Integration",
    description:
      "Designed to connect with wider institutional systems for better operational continuity.",
    icon: Database,
  },
  {
    title: "Reduced Disputes & Paperwork",
    description:
      "Replaces manual registers with dependable digital attendance records that reduce disputes and paperwork.",
    icon: Users,
  },
];
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-64px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              Track attendance with BAMS — a fingerprint-based attendance
              platform built for institutions that need{" "}
              <strong className="font-semibold text-primary-cbe-500">
                trainer-initiated sessions
              </strong>
              ,{" "}
              <strong className="font-semibold text-primary-cbe-500">
                automatic attendance percentages
              </strong>
              , real-time reporting, and integration support.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/bams/schedule-demo");
                }}
              >
                Book a Demo
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold leading-tight text-slate-800">
                  Auto percentage enabled
                </p>
                <p className="mt-0.5 text-sm text-slate-400">
                  Automatic session attendance calculation
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">BAMS</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for institutions that need
                accurate, tamper-resistant attendance capture with less manual
                paperwork, fewer disputes, and stronger operational control.
              </motion.p>
              <motion.p variants={fadeUp}>
                With trainer-initiated sessions, automated percentage
                calculation, and real-time reporting, BAMS centralizes the
                attendance lifecycle inside one connected platform.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Built for secure attendance capture across institutions that
                require dependable fingerprint-based verification.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built to eliminate proxy attendance
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    BAMS replaces manual registers with secure biometric
                    attendance workflows that improve punctuality, compliance,
                    reporting accuracy, and accountability.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why BAMS" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Accuracy, <br />
            Control, and <span className="text-primary-cta">Visibility.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            BAMS combines biometric capture, trainer-led sessions, automatic
            percentage calculation, and real-time reporting in one product
            experience.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why BAMS" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Accuracy, Control, and{" "}
        ...
        >
          {[
            {
              title: "Designed for Staff & Student Attendance",
              description:
                "Built specifically to manage biometric attendance for both staff and students from one connected platform.",
              icon: GraduationCap,
              cta: "Track Attendance",
              featured: false,
            },
            {
              title: "Eliminates Proxy Attendance",
              description:
                "Fingerprint-based verification helps stop impersonation and strengthens attendance integrity.",
              icon: CheckCircle2,
              cta: "Live Reports",
              featured: true,
            },
            {
              title: "Trainer-Initiated Sessions",
              description:
                "Allows trainers to initiate attendance sessions for stronger control over attendance capture.",
              icon: Workflow,
              cta: "Start Sessions",
              featured: false,
            },
            {
              title: "Automatic Percentage Calculation",
              description:
                "Automatically calculates attendance percentages to reduce manual work and disputes.",
              icon: Layers3,
            ...
            },
            {
              title: "Reduced Disputes & Paperwork",
              description:
                "Digital attendance records cut paperwork and help resolve attendance disagreements faster.",
              icon: FileBarChart2,
              cta: "View Records",
              featured: false,
            },
            {
              ...
              description:
                "Provides timely attendance insights for better punctuality monitoring and compliance tracking.",
              icon: BarChart3,
              cta: "All Features",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Biometric <span className="text-primary-cta">Attendance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From fingerprint capture to trainer-led sessions, reporting,
            percentage calculation, and system integration, BAMS centralizes
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Biometric{" "}
            <span className="text-primary-cta">Attendance.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  <motion.div variants={fadeUp}>
                    <BadgePill
                      label="Security & system readiness"
                      centered={false}
                    />
                  </motion.div>
                  <motion.h2
                  ...
                  >
                    ...
                    <span className="text-primary-cta">
                      Attendance Control and Connected Operations.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    ...
                    "Trainer-initiated attendance sessions",
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              <motion.div variants={fadeUp}>
                <BadgePill label="Product Preview" centered={false} />
              </motion.div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        BAMS Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Live biometric attendance visibility
                      </p>
                    </div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Attendance Control with{" "}
                  <span className="text-primary-cta">BAMS</span>.
                </motion.h2>
                ...
                >
                  Eliminate proxy attendance, reduce paperwork, and improve
                  punctuality and compliance with biometric attendance
                  management.
                </motion.p>
              </div>
