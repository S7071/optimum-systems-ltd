...
const complianceItems: CardItem[] = [
  {
    title: "Lease Governance",
    description:
      "Automates lease and contract handling, including escalations, renewals, and structured tenancy workflows.",
    icon: BadgeCheck,
  },
  {
    title: "Receivables Control",
    description:
      "Strengthens rent billing, penalties, and collection tracking across units, tenants, and properties.",
    icon: Landmark,
  },
  {
    title: "Audit-Ready Records",
    description:
      "Maintains organized financial, tenant, and operational records that support accountability and reporting.",
    icon: ClipboardCheck,
  },
  {
    title: "Controlled Access",
    description:
      "Supports secure user access, role-based controls, and safer handling of tenant and portfolio data.",
    icon: Network,
  },
  {
    title: "Portfolio Visibility",
    description:
      "Provides centralized dashboards and reporting for occupancy, collections, maintenance, and portfolio performance.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    ...
    description:
      "Centralizes property, block, floor, and unit details for stronger portfolio organization and control.",
    icon: Layers3,
  },
  {
    title: "Tenant Lifecycle Management",
    description:
      "Manages onboarding, occupancy, move-ins, renewals, notices, and tenant records from one scalable workflow.",
    icon: ClipboardCheck,
  },
  {
    title: "Automated Lease Administration",
    description:
      "Handles lease terms, escalations, renewals, and contract timelines with less manual follow-up.",
    icon: BarChart3,
  },
  {
    title: "Rent Billing & Receivables",
    description:
      "Automates invoicing, collections, penalties, and payment tracking across multiple properties and tenants.",
    icon: FileBarChart2,
  },
  {
    title: "Maintenance & Service Requests",
    description:
      "Tracks service issues, work orders, and maintenance resolution to preserve assets and improve tenant satisfaction.",
    icon: Building2,
  },
  {
    title: "Financial & Accounting Control",
    description:
      "Integrates property operations with accounting workflows for clearer reporting, reconciliation, and oversight.",
    icon: Lock,
  },
  {
    title: "Sales & Marketing Support",
    description:
      "Supports developers with lead handling, sales follow-up, and visibility into property movement and demand.",
    icon: Database,
  },
  {
    title: "Portfolio Analytics Dashboards",
    description:
      "Delivers real-time performance insight across occupancy, collections, revenue, and asset-level trends.",
    icon: Users,
  },
];
...
export default function REMSPage() {
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
        ...
        <div className="grid min-h-[calc(100vh-284px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              ...
              <span className="text-xs font-extrabold uppercase tracking-widest text-primary-cbe-500">
                ...
                <span className="text-primary-cta">REM</span>) System
              </span>
            </motion.div>
            ...
            >
              Manage properties, tenants, leases, collections, maintenance, and
              portfolio performance from one scalable platform. Built to reduce
              leakages, accelerate collections, and improve control across
              growing real estate operations.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/rems/schedule-demo");
                }}
              >
                Book a Demo
            ...
            >
              <span className="text-sm text-slate-600">
                ...
                · ideal for{" "}
                <strong className="font-semibold text-primary-cbe-500">
                  developers, malls, and corporate portfolios
                </strong>
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <Image
                src="/heros/rems.jpg"
                alt="Real estate portfolio management dashboard preview"
                fill
                priority
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold leading-tight text-slate-800">
                  Collections & lease control
                </p>
                <p className="mt-0.5 text-sm text-slate-400">
                  Automated billing, renewals, and tracking
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">REMS</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mt-4 text-base leading-7 text-slate-600 sm:text-lg"
              >
                A comprehensive property enterprise platform for managing real
                estate portfolios end-to-end across residential, commercial, and
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for firms that need stronger
                control over properties, tenants, leases, billing, maintenance,
                and financial performance across one or many sites.
              </motion.p>
              <motion.p variants={fadeUp}>
                It replaces fragmented spreadsheets and manual follow-up with
                structured workflows that improve collections, visibility,
                tenant service, and long-term asset performance.
              </motion.p>
            </motion.div>
            ...
            >
              {["Residential", "Commercial", "Mixed-Use"].map((pathway) => (
                <motion.span
                  key={pathway}
                  variants={fadeUp}
                  whileHover={{ y: -3 }}
          ...
          >
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Portfolio & Unit Control
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Built to centralize property and unit data across single-site
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Manages tenant onboarding, occupancy, renewals, notices, and key
                tenancy workflows in one system.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Property operators need more than rent trackers. REMS
                    supports a broader shift toward connected, controlled, and
                    scalable portfolio operations across leasing, collections,
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why REMS" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
          ...
          >
            REMS combines lease administration, rent control, maintenance
            coordination, and real-time portfolio visibility in one connected
            product experience.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why REMS" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Control, Collections, and{" "}
            <span className="text-primary-cta">Visibility.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
          ...
          {[
            {
              ...
              description:
                "Centralizes properties, units, tenants, leases, billing, and service workflows inside one connected platform.",
              icon: Building2,
              cta: "Manage Portfolio",
              featured: false,
            },
            {
              title: "Faster Rent Collections",
              description:
                "Automates billing, receivables, penalties, and multi-channel payments to improve cash flow and reduce leakages.",
              icon: CheckCircle2,
            ...
            },
            {
              title: "Automated Lease Administration",
              description:
                "Handles escalations, renewals, contract milestones, and tenant obligations with less manual follow-up.",
              icon: Workflow,
              cta: "View Leases",
              featured: false,
            },
            {
              ...
              description:
                "Tracks requests, assignments, and resolution workflows to preserve assets and improve tenant satisfaction.",
              icon: Layers3,
              cta: "Manage Requests",
              featured: false,
            },
            {
              ...
              description:
                "Connects property operations with accounting processes for stronger oversight, reporting, and decision-making.",
              icon: FileBarChart2,
              cta: "View Financials",
              featured: false,
            },
            {
              title: "Portfolio Visibility & Growth",
              description:
                "Provides real-time dashboards across occupancy, revenue, collections, and performance for multi-property growth.",
              icon: BarChart3,
              cta: "See Analytics",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Property <span className="text-primary-cta">Operations.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From tenant onboarding and lease administration to billing,
            maintenance, financial control, and analytics, REMS centralizes the
            property operations stack.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Property{" "}
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  <motion.p
                    ...
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    REMS supports stronger governance across leasing,
                    collections, maintenance, financial control, and safer
                    handling of operational data.
                  </motion.p>
                </div>
              </div>
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "Lease and contract management controls",
                    "Rent billing, receivables, and penalty automation",
                    "Role-based access and controlled workflows",
                    "Audit-ready financial and portfolio records",
                    "Secure handling of tenant and operational data",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
            ...
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  ...
                  <br />
                  Operations with
                  <span className="text-primary-cta"> REMS</span>
                </motion.h2>
                ...
                >
                  Eliminate manual tracking and revenue leakages with a
                  connected platform for properties, tenants, leases, rent
                  billing, maintenance, accounting, and portfolio analytics.
                  Built for operators managing growth across multiple
                  properties.
                </motion.p>
              </motion.div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        REMS Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Real-time portfolio visibility for property operators
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Manage escalations, renewals, and contract timelines
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Track rent billing, receivables, penalties, and payment
                        status across properties.
                      </p>
                    </div>
                  </div>
                </motion.div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Property Management with{" "}
                  <span className="text-primary-cta">REMS</span>.
                </motion.h2>
                ...
                >
                  Accelerate collections, improve occupancy, streamline
                  maintenance, and manage portfolio performance from one
                  connected property ERP.
                </motion.p>
              </div>
