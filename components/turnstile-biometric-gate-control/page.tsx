...
const complianceItems: CardItem[] = [
  {
    ...
    description:
      "Supports fingerprint and facial authentication to verify identity at the gate and reduce impersonation.",
    icon: BadgeCheck,
  },
  {
    title: "Access Rule Enforcement",
    description:
      "Applies role-, time-, and zone-based permissions so entry follows approved policies at every checkpoint.",
    icon: Landmark,
  },
  {
    title: "Attendance & ERP Sync",
    description:
      "Synchronizes gate events with attendance and ERP workflows for centralized operational control.",
    icon: ClipboardCheck,
  },
  {
    title: "Real-Time Alerts & Analytics",
    description:
      "Provides live alerts, entry and exit analytics, and movement visibility for faster decision-making.",
    icon: Network,
  },
  {
    title: "Encryption & Compliance",
    description:
      "Supports secure access governance with strong encryption, controlled data handling, and audit-ready oversight.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "Fingerprint & Facial Authentication",
    description:
      "Verifies each user through biometric identity checks before access is granted at the turnstile.",
    icon: Layers3,
  },
  {
    title: "Full-Height Anti-Tailgating Turnstiles",
    description:
      "Combines hardware deterrence with controlled passage to stop piggybacking and unauthorized entry.",
    icon: ClipboardCheck,
  },
  {
    title: "Entry & Exit Analytics",
    description:
      "Tracks movement trends, access history, and facility traffic for operational and security insight.",
    icon: BarChart3,
  },
  {
    title: "Eligibility Enforcement",
    description:
      "Can enforce access based on fee status, user category, or other approved institutional rules.",
    icon: FileBarChart2,
  },
  {
    title: "Role, Time & Zone Permissions",
    description:
      "Restricts access by user role, approved schedule, and defined zones for tighter governance.",
    icon: Building2,
  },
  {
    title: "Secure Access Governance",
    description:
      "Strengthens perimeter control with encryption, controlled records, and compliance-oriented access management.",
    icon: Lock,
  },
  {
    title: "Attendance & ERP Synchronization",
    description:
      "Feeds gate activity into attendance and ERP processes for unified visibility and automated workflows.",
    icon: Database,
  },
  {
    title: "Mobile Admin Dashboard",
    description:
      "Gives administrators live oversight of access events, alerts, and movement patterns from one interface.",
    icon: Users,
  },
];
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
          ...
          >
            ...
            >
              <div className="flex size-12 flex-shrink-0 items-center justify-center rounded-lg border border-primary-cbe-100 bg-background p-1.5">
                <Image
                  src="/logos/turnstile-bio.svg"
                  alt="Turnstile Biometric Gate Control System"
                  width={12}
                  height={12}
            ...
            >
              Control who gets in, when, and where with full-height
              anti-tailgating turnstiles,{" "}
              ...
              synced to attendance and ERP workflows.
            </motion.p>
            ...
            >
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogTitle className="sr-only">
                  Turnstile Gate Control Overview
                </DialogTitle>
                <DialogContent className="max-w-4xl overflow-hidden p-0">
                  <div className="aspect-video w-full">
                    <iframe
                      ...
                      title="Turnstile Biometric Gate Control System Overview"
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">Turnstile</span>{" "}
              ...
              >
                An integrated physical and digital access governance solution
                with full-height anti-tailgating turnstiles and biometric
                identity control.
              </motion.p>
            </div>
            ...
            >
              <motion.p variants={fadeUp}>
                ...
                stronger perimeter control, verified identity at entry points,
                and policy-based access across critical facilities.
              </motion.p>
              <motion.p variants={fadeUp}>
                It combines hardware deterrence with digital intelligence to
                prevent unauthorized access, enforce eligibility rules, and
                generate real-time movement insight from one connected system.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Full-Height Access Control
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Built for strict gate integrity with full-height turnstiles that
                regulate entry and deter tailgating.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Supports fingerprint and facial authentication to reduce
                impersonation and confirm identity before access is granted.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for secure multi-site operations
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Modern facilities need more than guards and manual logs.
                    This platform unifies barrier control, biometrics,
                    attendance sync, and policy enforcement in one governed
                    access layer.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Turnstile Gate Control" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Built for Control, <br />
            Integrity, and <span className="text-primary-cta">Visibility.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            Turnstile Gate Control combines biometric identity checks,
            anti-tailgating hardware, policy enforcement, and live access
            visibility in one product experience.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Turnstile Gate Control" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Built for Control, Integrity, and{" "}
        ...
        >
          {[
            {
              title: "Designed for Strict Access Integrity",
              description:
                "Built for facilities that need verified identity, controlled entry points, and stronger perimeter discipline.",
              icon: ShieldCheck,
              cta: "Control Access",
              featured: false,
            },
            {
              title: "Hardware + Digital Control",
              description:
                "Combines full-height turnstiles with biometric and policy intelligence for tighter gate governance.",
              icon: CheckCircle2,
              cta: "See Visibility",
              featured: true,
            },
            {
              title: "Role, Time & Zone Enforcement",
              description:
                "Applies configurable permissions so users only access approved areas at approved times.",
              icon: Workflow,
              cta: "Set Policies",
              featured: false,
            },
            {
              title: "Attendance & ERP Synchronization",
              description:
                "Feeds turnstile events into attendance and ERP workflows to eliminate disconnected records.",
              icon: Layers3,
              cta: "Sync Records",
              featured: false,
            },
            {
              ...
              description:
                "Reduces manual loopholes, unauthorized access, and attendance fraud through verified entry logs.",
              icon: FileBarChart2,
              cta: "Review Events",
              featured: false,
            },
            {
              title: "Real-Time Entry/Exit Visibility",
              description:
                "Gives administrators live insight into movement trends, alerts, and access events across facilities.",
              icon: BarChart3,
              cta: "All Features",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Biometric Gate <span className="text-primary-cta">Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From identity verification to policy enforcement, attendance
            synchronization, analytics, and live alerts, the platform
            centralizes secure access operations.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Biometric Gate{" "}
            <span className="text-primary-cta">Control.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
              ...
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  <motion.p
                    ...
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    The platform supports controlled biometric access, secure
                    data handling, and audit-ready governance for high-integrity
                    facilities.
                  </motion.p>
                </div>
              </div>
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    ...
                    "Role-, time-, and zone-based policy enforcement",
                    "Attendance and ERP synchronization",
                    "Strong encryption and secure data handling",
                    "Audit-ready entry and exit traceability",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
            ...
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  ...
                  <br />
                  Access with
                  <span className="text-primary-cta"> Turnstile</span> Gate
                  Control
                </motion.h2>
                ...
                >
                  Prevent unauthorized access, impersonation, and attendance
                  fraud with full-height turnstiles, biometric identity checks,
                  rule-based permissions, and real-time visibility from one
                  connected access governance platform.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  ...
                  <DialogTitle className="sr-only">
                    Turnstile Gate Control Product Overview
                  </DialogTitle>
                  <DialogContent className="max-w-4xl overflow-hidden p-0">
                    <div className="aspect-video w-full">
                      <iframe
                        className="h-full w-full"
                        src="https://www.youtube.com/embed/Da1hUqzoiAo?autoplay=1"
                        title="Turnstile Gate Control Product Overview"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    </div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        Access Control Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Live movement, identity, and policy visibility
                      </p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-[1.4rem] bg-white">
                    ...
                    >
                      <Image
                        ...
                        alt="Turnstile biometric gate control dashboard preview"
                        width={1400}
                        height={900}
                        priority
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Facility Access with{" "}
                  <span className="text-primary-cta">Turnstile</span> Gate
                  Control.
                </motion.h2>
                ...
                >
                  Secure facilities with biometric verification, anti-tailgating
                  control, and real-time access intelligence.
                </motion.p>
              </div>
