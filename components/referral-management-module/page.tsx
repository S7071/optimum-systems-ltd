...
const complianceItems: CardItem[] = [
  {
    title: "Verified Enrollment Controls",
    description:
      "Rewards are triggered only after confirmed enrollment so referral payouts stay accurate, accountable, and auditable.",
    icon: BadgeCheck,
  },
  {
    title: "Campaign Governance",
    description:
      "Supports structured campaign execution with clear tracking, ownership, and visibility across referral initiatives.",
    icon: Landmark,
  },
  {
    title: "Reward Rule Management",
    description:
      "Automates tiered cash or discount incentives using consistent rules that reduce disputes and manual follow-up.",
    icon: ClipboardCheck,
  },
  {
    title: "ERP Integration",
    description:
      "Connects referral workflows to institutional ERP processes for synchronized lead, enrollment, and reward visibility.",
    icon: Network,
  },
  {
    title: "Secure Data Handling",
    description:
      "Supports controlled access, protected records, and responsible handling of referrer and prospect information.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "Referrer & Lead Tracking",
    description:
      "Captures referrers, prospects, and status updates in one workflow so institutions can monitor every referral clearly.",
    icon: Layers3,
  },
  {
    title: "Tiered Reward Automation",
    description:
      "Automates cash or discount rewards using structured tiers once verified enrollment conditions are met.",
    icon: ClipboardCheck,
  },
  {
    title: "Conversion & ROI Analytics",
    description:
      "Delivers real-time insight into conversion performance, campaign efficiency, and referral return on investment.",
    icon: BarChart3,
  },
  {
    title: "Campaign Management",
    description:
      "Supports referral drives, seasonal recruitment pushes, and targeted outreach initiatives from one central module.",
    icon: FileBarChart2,
  },
  {
    title: "Referrer & Admin Portals",
    description:
      "Provides dedicated portal experiences for tracking leads, monitoring rewards, and managing program performance.",
    icon: Building2,
  },
  {
    title: "Secure Data Handling",
    description:
      "Protects referral and prospect records with controlled access and accountable workflow governance.",
    icon: Lock,
  },
  {
    title: "ERP-Connected Workflows",
    description:
      "Integrates referral activity with the wider ERP so teams can connect lead movement to verified enrollment outcomes.",
    icon: Database,
  },
  {
    title: "Community-Driven Growth",
    description:
      "Turns trusted networks into a measurable enrollment channel that strengthens engagement and lowers marketing costs.",
    icon: Users,
  },
];
...
export default function ReferralManagementModulePage() {
    ...
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-284px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              <div className="flex size-12 flex-shrink-0 items-center justify-center rounded-lg border border-primary-cbe-100 bg-background p-1.5">
                <Image
                  src="/logos/referral.svg"
                  alt="Referral Management Module"
                  width={12}
                  height={12}
              ...
              <span className="text-xs font-extrabold uppercase tracking-widest text-primary-cbe-500">
                <span className="text-primary-cta">REFERRAL</span> MANAGEMENT
                MODULE
              </span>
            </motion.div>
            ...
            >
              Structure word-of-mouth recruitment inside your ERP with tracked
              referrers, lead status visibility,{" "}
              <strong className="font-semibold text-primary-cbe-500">
                tiered rewards on verified enrollment
              </strong>
              , and{" "}
              <strong className="font-semibold text-primary-cbe-500">
                conversion and ROI analytics
              </strong>
              . Built for institutions that want cost-effective enrollment
              growth.
            </motion.p>
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/referral-management-module/schedule-demo");
                }}
              >
                Request a Demo
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogTitle className="sr-only">
                  Referral Management Module Overview
                </DialogTitle>
                <DialogContent className="max-w-4xl overflow-hidden p-0">
                  <div className="aspect-video w-full">
                    <iframe
                      ...
                      title="Referral Management Module Overview"
            ...
            >
              ...
              <span className="text-sm text-slate-600">
                <strong className="font-semibold text-primary-cbe-500">
                  Enrollment growth engine
                </strong>{" "}
                · built for TVETs, universities, colleges, and training centers
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <Image
                src="/heros/referral.png"
                alt="Referral management module hero visual"
                fill
                priority
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-400">
                  Tiered rewards after verified enrollment
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                An ERP-connected enrollment growth engine that structures
                word-of-mouth referrals into a trackable, reward-driven
            ...
            >
              <motion.p variants={fadeUp}>
                The module captures referrers, leads, campaign sources, and
                status changes in one place so institutions can monitor
                recruitment pipelines with clarity and accountability.
              </motion.p>
              <motion.p variants={fadeUp}>
                Once enrollment is verified, it automates tiered incentives,
                strengthens community-driven recruitment, and reveals which
                referral channels are producing the strongest conversion ROI.
              </motion.p>
            </motion.div>
            ...
            >
              {["TVETs", "Universities", "Private Colleges"].map((pathway) => (
                <motion.span
                  key={pathway}
                  variants={fadeUp}
                  whileHover={{ y: -3 }}
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Track referrers, prospects, and pipeline status from first lead
                to confirmed enrollment in one organized workflow.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Reward-Driven Conversion
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Turn successful referrals into automated cash or discount
                rewards using clear, verified enrollment conditions.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for cost-effective enrollment expansion
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Institutions need more than informal referrals. This module
                    introduces structured workflows, measurable rewards, and
                    real-time recruitment insight that help teams scale
                    enrollment with lower acquisition cost.
                  </p>
                </div>
      ...
      >
        ...
        >
          ...
          >
            Referral Management Module turns informal recruitment networks into
            a measurable strategy with clear workflows, rewards, analytics, and
            secure oversight.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why this module" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Module Designed for Growth, Accountability, and{" "}
            <span className="text-primary-cta">Visibility.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Structured Word-of-Mouth Growth",
              description:
                "Turns informal referral activity into a defined enrollment channel with clear ownership, lead movement, and follow-through.",
              icon: GraduationCap,
              cta: "Track Leads",
              featured: false,
            },
            {
              title: "Verified Reward Automation",
              description:
                "Automates tiered rewards after confirmed enrollment so institutions can scale referrals without manual payout chaos.",
              icon: CheckCircle2,
              cta: "View Insights",
              featured: true,
            },
            {
              title: "Referrer & Admin Portals",
              description:
                "Gives both promoters and internal teams visibility into referrals, statuses, rewards, and program activity.",
              icon: Workflow,
              cta: "Open Portals",
              featured: false,
            },
            {
              ...
              description:
                "Supports structured referral campaigns for intakes, departments, and targeted recruitment initiatives.",
              icon: Layers3,
              cta: "Run Campaigns",
              featured: false,
            },
            {
              title: "Conversion & ROI Analytics",
              description:
                "Shows which channels, campaigns, and referrers are delivering measurable enrollment outcomes and value.",
              icon: FileBarChart2,
              cta: "View Analytics",
              featured: false,
            },
            {
              title: "Secure ERP-Connected Records",
              description:
                "Links referral activity to the wider ERP while keeping lead, reward, and enrollment data well governed and traceable.",
              icon: BarChart3,
              cta: "See Workflow",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-primary-cta">Referral Program.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From lead capture and reward automation to referrer portals,
            campaign management, ROI reporting, and ERP integration, the module
            centralizes referral-led enrollment growth.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  <motion.div variants={fadeUp}>
                    <BadgePill label="Security & governance" centered={false} />
                  </motion.div>
                  <motion.h2
                    variants={fadeUp}
                    className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
                  >
                    Built for Controlled, Secure, and{" "}
                    <span className="text-primary-cta">
                      Accountable Referral Operations.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    The module supports secure data handling, verified reward
                    triggers, and structured governance for referral-led
                    enrollment programs.
                  </motion.p>
                </div>
              </div>
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "Secure data handling for referrer and prospect records",
                    "Verified enrollment conditions before reward release",
                    "Role-based access for referrers and administrators",
                    "ERP-connected referral and enrollment visibility",
                    "Audit-ready tracking for campaigns, rewards, and status changes",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              <motion.div variants={fadeUp}>
                <BadgePill label="Module preview" centered={false} />
              </motion.div>
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  Convert trusted networks into a measurable recruitment channel
                  with tracked referrals, automated incentives, campaign
                  support, and real-time ROI visibility. Built for institutions
                  that want stronger enrollment growth with lower marketing
                  waste.
                </motion.p>
              </motion.div>
              ...
              >
                {[
                  "Referrer & lead tracking",
                  "Rewards after enrollment",
                  "Campaign conversion stats",
                  "Referrer & admin portals",
                ].map((item) => (
                  <motion.div
                    key={item}
                    variants={fadeUp}
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        Referral Management Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Track leads, rewards, and campaign performance
                      </p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-[1.4rem] bg-white">
                    ...
                    >
                      <Image
                        ...
                        alt="Referral Management Module product preview"
                        width={1400}
                        height={900}
                        priority
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Monitor each referral from first submission to verified
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500 line-clamp-2">
                        Automate cash or discount incentives by campaign,
                        threshold, or enrollment milestone.
                      </p>
                    </div>
                  </div>
                </motion.div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Turn Referral Networks into{" "}
                  <span className="text-primary-cta">Measurable Growth.</span>
                </motion.h2>
                ...
                >
                  Launch a referral program that tracks leads, automates
                  rewards, and gives your team clear visibility into what is
                  driving verified enrollment growth.
                </motion.p>
              </div>
