...
const complianceItems: CardItem[] = [
  {
    ...
    description:
      "Maintains visibility across milk intake, processing, storage, and distribution for stronger accountability.",
    icon: BadgeCheck,
  },
  {
    title: "Quality Control Workflows",
    description:
      "Supports digitized quality checks at intake and throughout production to protect product integrity.",
    icon: Landmark,
  },
  {
    title: "Audit-Ready Records",
    description:
      "Keeps structured operational and financial records that reduce disputes and simplify oversight.",
    icon: ClipboardCheck,
  },
  {
    title: "Cold Chain Visibility",
    description:
      "Tracks inventory and movement across storage and distribution points to reduce spoilage risk.",
    icon: Network,
  },
  {
    title: "Secure Access & Controls",
    description:
      "Supports controlled access, secure handling of records, and accountability across dairy operations.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    title: "Farmer & Supplier Profiles",
    description:
      "Maintains structured records for farmers and suppliers to support clean operations and better service delivery.",
    icon: Layers3,
  },
  {
    title: "Milk Intake & Quality Testing",
    description:
      "Digitizes milk reception, testing, and acceptance workflows for faster, more accurate intake control.",
    icon: ClipboardCheck,
  },
  {
    title: "Processing & Yield Oversight",
    description:
      "Tracks production, BOMs, yield, and wastage to improve planning, efficiency, and manufacturing control.",
    icon: BarChart3,
  },
  {
    title: "Inventory & Cold Chain Tracking",
    description:
      "Monitors stock movement and storage conditions to reduce losses, spoilage, and stock uncertainty.",
    icon: FileBarChart2,
  },
  {
    title: "Automated Farmer Payments",
    description:
      "Supports quality-linked payment workflows that speed settlement cycles and reduce reconciliation disputes.",
    icon: Building2,
  },
  {
    title: "Secure Financials & Reporting",
    description:
      "Centralizes GL, AP/AR, and reporting with controlled access and better visibility into dairy performance.",
    icon: Lock,
  },
  {
    title: "Distribution & Logistics",
    description:
      "Supports movement of finished products across routes, branches, and delivery points from one system.",
    icon: Database,
  },
  {
    title: "HR, Payroll & Dashboards",
    description:
      "Connects workforce management with executive dashboards for real-time operational and profitability insight.",
    icon: Users,
  },
];

const PLATFORM_FEATURES = [
  "Milk Intake Digitization",
  "Quality Testing",
  "Farmer Payments",
  "Cold Chain Tracking",
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
      ...
      >
        <div className="grid min-h-[calc(100vh-284px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              Manage the milk value chain end to end with Dairy Management
              System — a complete ERP with real-time visibility,{" "}
              ...
              . Built for modern dairy operations.
            </motion.p>
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold leading-tight text-slate-800">
                  Farmer payments automated
                </p>
                <p className="mt-0.5 text-sm text-slate-400">
                  Quality-linked settlement workflows
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                A complete ERP for dairy cooperatives and processors, unifying
                milk intake, production, inventory, financials, and distribution
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for dairy businesses that need
                tighter intake control, production visibility, stronger
                accountability, and faster decision-making across the operation.
              </motion.p>
              <motion.p variants={fadeUp}>
                It replaces fragmented manual processes with one connected
                environment for milk intake, quality testing, processing
                oversight, farmer payments, inventory control, and logistics.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Built to connect farm intake, processing, inventory, finance,
                and distribution within one coordinated ERP.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-semibold text-primary-cbe-500">
                Digitized Intake & Quality Testing
              </h3>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Turns manual reception and quality checks into faster,
                standardized, and more transparent intake workflows.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for operational transformation
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Dairy businesses need more than siloed records. Dairy
                    Management System supports a broader shift toward
                    transparent operations, lower losses, faster payments, and
                    scalable profitability across the milk value chain.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Dairy Management System" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
          ...
          >
            ...
            Transparency, and{" "}
            <span className="text-primary-cta">Traceability.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            Dairy Management System combines intake control, processing
            oversight, payment automation, and real-time operational visibility
            in one connected product experience.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Dairy Management System" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Control, Transparency, and{" "}
            <span className="text-primary-cta">Traceability.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Built for the Milk Value Chain",
              description:
                "Connects intake, processing, inventory, finance, and distribution in one ERP built for dairy operations.",
              icon: GraduationCap,
            ...
            },
            {
              ...
              description:
                "Strengthens accountability with traceable workflows, clearer records, and better visibility across branches and plants.",
              icon: CheckCircle2,
              cta: "Live Insights",
              featured: true,
            },
            {
              title: "Digitized Intake Control",
              description:
                "Captures milk reception and quality checks in real time to reduce delays, disputes, and manual errors.",
              icon: Workflow,
              cta: "Track Intake",
              featured: false,
            },
            {
              title: "Automated Farmer Payments",
              description:
                "Supports faster settlement through quality-linked payment workflows and stronger financial control.",
              icon: Layers3,
              cta: "View Workflows",
              featured: false,
            },
            {
              title: "Reduced Losses & Spoilage",
              description:
                "Improves production, inventory, and cold-chain oversight to cut wastage and protect margins.",
              icon: FileBarChart2,
              cta: "Reduce Losses",
              featured: false,
            },
            {
              ...
              description:
                "Delivers real-time dashboards on intake, production, finances, and profitability for faster decisions.",
              icon: BarChart3,
              cta: "All Features",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Dairy <span className="text-primary-cta">Operations.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From milk intake and quality testing to farmer payments, inventory,
            distribution, and financial reporting, Dairy Management System
            centralizes the dairy operating stack.
          </motion.p>
        </motion.div>
        <motion.div
          variants={staggerContainer}
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Dairy{" "}
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  ...
                  >
                    ...
                    <span className="text-primary-cta">
                      Operational and Traceability Standards.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    Dairy Management System supports accountable dairy
                    operations through traceable workflows, controlled records,
                    and stronger financial and operational discipline.
                  </motion.p>
                </div>
              </div>
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "End-to-end milk intake and movement traceability",
                    "Digitized quality testing and acceptance workflows",
                    "Inventory and cold-chain visibility across operations",
                    "Structured farmer payment and financial controls",
                    "Role-based access and audit-ready operational records",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  Run transparent, efficient, and scalable dairy operations from
                  one connected platform. Dairy Management System helps
                  organizations manage intake, quality testing, production,
                  farmer payments, inventory, distribution, and performance
              ...
              >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  ...
                  <DialogTitle className="sr-only">
                    Dairy Management System Product Overview
                  </DialogTitle>
                  <DialogContent className="max-w-4xl overflow-hidden p-0">
                    <div className="aspect-video w-full">
                      <iframe
                        className="h-full w-full"
                        src="https://www.youtube.com/embed/Da1hUqzoiAo?autoplay=1"
                        title="Dairy Management System Product Overview"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    </div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        Dairy Management System Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Farm-to-distribution visibility for dairy operations
                      </p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-[1.4rem] bg-white">
                    ...
                    >
                      <Image
                        ...
                        alt="Dairy Management System product preview"
                        width={1400}
                        height={900}
                        priority
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Unify intake, production, farmer payments, inventory, and
                  distribution with one ERP built for dairy cooperatives and
                  processors.
                </motion.p>
              </div>
