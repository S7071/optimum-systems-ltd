...
const complianceItems: CardItem[] = [
  {
    title: "KYC Workflows",
    description:
      "Supports structured customer onboarding and verification workflows for stronger lending governance.",
    icon: BadgeCheck,
  },
  {
    title: "1/3 Rule Controls",
    description:
      "Built to support automated repayment checks and lending controls aligned to internal credit policies.",
    icon: Landmark,
  },
  {
    title: "Audit Trails",
    description:
      "Maintains clear transaction visibility across appraisal, disbursement, repayment, and portfolio activity.",
    icon: ClipboardCheck,
  },
  {
    title: "MPESA & SMS Integration",
    description:
      "Connects lending operations with mobile money and messaging workflows for faster servicing and engagement.",
    icon: Network,
  },
  {
    title: "Secure Data Handling",
    description:
      "Supports controlled access, protected records, and stronger data governance across lending operations.",
    icon: ShieldCheck,
  },
];
...
const featureItems: CardItem[] = [
  {
    ...
    description:
      "Centralizes customer onboarding, profile management, and verification workflows in one connected system.",
    icon: Layers3,
  },
  {
    title: "Configurable Loan Products",
    description:
      "Set up flexible loan products, terms, repayment structures, and lending rules to match your operation.",
    icon: ClipboardCheck,
  },
  {
    title: "Portfolio Monitoring & Analytics",
    description:
      "Tracks portfolio performance, repayment behavior, and lending trends with real-time visibility.",
    icon: BarChart3,
  },
  {
    title: "Automated Appraisal & Disbursement",
    description:
      "Streamlines appraisal, approval, and disbursement processes for faster and more controlled lending.",
    icon: FileBarChart2,
  },
  {
    title: "Repayment & 1/3 Rule Controls",
    description:
      "Supports automated repayment workflows and internal lending controls, including 1/3 rule handling.",
    icon: Building2,
  },
  {
    title: "Secure Records & Access Control",
    description:
      "Protects sensitive lending data with controlled access, secure records, and audit-friendly workflows.",
    icon: Lock,
  },
  {
    title: "Financials, HR & Payroll",
    description:
      "Unifies lending operations with finance, HR, and payroll to improve back-office efficiency.",
    icon: Database,
  },
  {
    title: "MPESA & SMS Integration",
    description:
      "Connects your lending platform to mobile money and messaging for repayments, alerts, and client engagement.",
    icon: Users,
  },
];
...
export default function Lend360ManagementSystemPage() {
  ...
  return (
    <main className="w-full bg-white text-primary-cbe-500">
        ...
        <div className="grid min-h-[calc(100vh-64px)] grid-cols-1 md:grid-cols-2 md:max-h-[760px]">
          ...
          >
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-primary-cbe-800">
                <span className="font-extrabold text-primary-cta">Lend360</span>{" "}
                MANAGEMENT SYSTEM
              </span>
            </motion.div>
            ...
            >
              The Ultimate Microfinance{" "}
              <span className="font-bold text-primary-cta">ERP System</span>
            </motion.h1>
            ...
            >
              Manage onboarding, loan products, appraisal, disbursement, and
              repayment seamlessly with Lend360 — a connected lending platform
              with{" "}
              <strong className="font-semibold text-primary-cbe-500">
                MPESA and SMS integration
              </strong>
              , built-in{" "}
              <strong className="font-semibold text-primary-cbe-500">
                1/3 rule controls
            ...
            >
              <Button
                variant="default"
                onClick={() => {
                  router.push("/lend360-management-system/schedule-demo");
                }}
              >
                Book a Demo
          ...
          >
            <Image
              ...
              alt="Lending operations and client service workflow"
              fill
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-400">
                  Smarter appraisal and repayment control
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div variants={fadeLeft}>
            <div className="mx-auto max-w-3xl text-left">
              ...
              >
                What is <span className="text-primary-cta">Lend360</span>?
              </motion.h2>
              <motion.p
                variants={fadeUp}
                className="mt-4 text-base leading-7 text-slate-600 sm:text-lg"
              >
                A full-cycle lending ERP for microfinance institutions and
                lending companies, built to manage customers, loans, finance,
                and back-office operations in one platform.
              </motion.p>
            </div>
            ...
            >
              <motion.p variants={fadeUp}>
                The platform is purpose-built for lenders seeking stronger
                customer onboarding, faster loan processing, tighter repayment
                control, and better portfolio visibility across the business.
              </motion.p>
              <motion.p variants={fadeUp}>
                It centralizes KYC, configurable loan products, appraisal,
                disbursement, repayment, financials, HR/payroll, and analytics
                inside one connected lending system.
              </motion.p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Configure lending products, repayment structures, and internal
                credit rules to suit your lending model.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Manage appraisal, approval, disbursement, repayment, and client
                servicing across the full lending cycle.
              </p>
            </motion.div>
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary-cbe-500">
                    Built for lending transformation
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                    Modern lenders need more than spreadsheets and fragmented
                    tools. Lend360 supports reliable, efficient, and controlled
                    lending operations from customer onboarding to portfolio
                    monitoring.
                  </p>
                </div>
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Lend360" centered={true} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
          ...
          >
            Lend360 combines customer onboarding, loan servicing, collections,
            financials, HR/payroll, and real-time portfolio visibility in one
            product experience.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div variants={fadeUp}>
            <BadgePill label="Why Lend360" centered={false} />
          </motion.div>
          <motion.h2
            variants={fadeUp}
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            A Platform Designed for Control, Automation, and{" "}
            <span className="text-primary-cta">Visibility.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
        ...
        >
          {[
            {
              title: "Built for Microfinance Operations",
              description:
                "Supports the full lending cycle from customer onboarding and appraisal to disbursement, repayment, and servicing.",
              icon: GraduationCap,
              cta: "View Workflow",
              featured: false,
            },
            {
              title: "Configurable Loan Products",
              description:
                "Set up flexible lending products, terms, repayment rules, and approval structures that fit your institution.",
              icon: CheckCircle2,
              cta: "Live Insights",
              featured: true,
            },
            {
              title: "Automated Appraisal & Disbursement",
              description:
                "Improves turnaround times by streamlining appraisal, approval, and disbursement in one integrated platform.",
              icon: Workflow,
              cta: "View Operations",
              featured: false,
            },
            {
              title: "MPESA & SMS Integrated",
              description:
                "Strengthens collections and client engagement through connected mobile money and messaging workflows.",
              icon: Layers3,
              cta: "Generate Reports",
              featured: false,
            },
            {
              title: "Finance, HR & Payroll Connected",
              description:
                "Combines operational lending workflows with finance, HR, and payroll to reduce back-office fragmentation.",
              icon: FileBarChart2,
              cta: "View Modules",
              featured: false,
            },
            {
              title: "Portfolio Monitoring & Analytics",
              description:
                "Provides real-time visibility into repayments, portfolio performance, and client activity for better decisions.",
              icon: BarChart3,
              cta: "All Features",
              featured: false,
            },
      ...
      >
        ...
        >
          ...
          >
            ...
            Lending <span className="text-primary-cta">Operations.</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-3"
          >
            From KYC and product configuration to loan servicing, collections,
            financials, HR/payroll, and analytics, Lend360 centralizes the
            lending stack.
          </motion.p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
          >
            Everything Needed to Run Modern Lending{" "}
            ...
            <motion.div variants={fadeLeft}>
              <div className="flex items-start justify-start gap-3 text-left">
                <div className="flex flex-col items-start gap-3">
                  <motion.div variants={fadeUp}>
                    <BadgePill
                      label="Security & operational governance"
                      centered={false}
                    />
                  </motion.div>
                  <motion.h2
                    ...
                    className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-primary-cbe-500 sm:text-4xl"
                  >
                    Designed for Secure, Controlled, and{" "}
                    <span className="text-primary-cta">
                      Auditable Lending Operations.
                    </span>
                  </motion.h2>
                  <motion.p
                    variants={fadeUp}
                    className="mx-auto max-w-[600px] text-md leading-[1.7] text-primary-cbe-800/60 line-clamp-10"
                  >
                    Lend360 supports secure data handling, transaction
                    visibility, and controlled operational workflows for modern
              ...
              >
                <ul className="space-y-4 text-sm leading-6 text-slate-600">
                  {[
                    "KYC-enabled customer onboarding",
                    "Role-based access and secure lending records",
                    "Audit trails across loan operations",
                    "MPESA and SMS integration support",
                    "Controlled data handling and governance",
                  ].map((item) => (
                    <motion.li
                      key={item}
                      variants={fadeUp}
            ...
            <motion.div variants={fadeLeft} className="flex flex-col gap-6">
              ...
              <motion.div variants={staggerContainer} className="space-y-4">
                ...
                >
                  ...
                  <br />
                  Operations with
                  <span className="text-primary-cta"> Lend360</span>
                </motion.h2>
                ...
                >
                  Centralize KYC, configurable loan products, appraisal,
                  disbursement, repayment, financials, HR/payroll, and analytics
                  in one connected lending platform built for microfinance
              ...
              >
                {[
                  ...
                  "Automated Appraisal & Disbursement",
                  "Repayment & 1/3 Rule Controls",
                  ...
                  <DialogContent className="max-w-4xl overflow-hidden p-0">
                    <div className="aspect-video w-full">
                      <iframe
                        className="h-full w-full"
                        src="https://www.youtube.com/embed/Da1hUqzoiAo?autoplay=1"
                        title="Lend360 Product Overview"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    </div>
                  ...
                  <div className="mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        Lend360 Dashboard Preview
                      </p>
                      <p className="mt-1 text-sm text-white/55">
                        Loan servicing and portfolio monitoring for lending
                        teams
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Configure lending products, repayment structures, and
                        approval rules in one system.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-slate-500">
                        Automate repayment tracking, collections workflows, and
                        internal 1/3 rule checks.
                      </p>
                    </div>
                  </div>
                </motion.div>
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="flex flex-1 flex-col justify-start pt-10">
                ...
                >
                  Transform Lending Operations with{" "}
                  <span className="text-primary-cta">Lend360</span>.
                </motion.h2>
                ...
                >
                  Drive faster onboarding, controlled lending workflows, and
                  real-time portfolio visibility from one connected platform.
                </motion.p>
              </div>
